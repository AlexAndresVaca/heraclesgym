...
class PagesController extends Controller
{
    ...
    public function inicio(Request $request)
    {
        ...
        if ($usuario == NULL) {
            ...
            $clientesExpirados = Ingreso::whereNotNull('anotacion_ing')->whereDate('created_at',$hoy)->get();
            // Conteo
            ...
            $clientesExpiradosMes = Ingreso::whereNotNull('anotacion_ing')->whereMonth('created_at',$mesActual)->whereYear('created_at',$anioActual)->get();
            // Conteo Mensual
            ...
            return view('app.inicio', compact('usuario','numMensuales','numDiarios','numExpirados','numMensualesMes','numDiariosMes','numExpiradosMes','productos'));
        }
    }
